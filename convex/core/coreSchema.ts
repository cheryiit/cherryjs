...
export const coreTables = {
  ...
  contents: defineTable(contentFields)
  ...
  // Migrations tracking — uses the helper-provided table validator so it
  // matches what `lib/migrations.ts` (makeMigration) expects.
