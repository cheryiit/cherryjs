...
export const scheduleTask = businessMutation({
  args: {
    name: v.string(),
...
export const cancelTask = businessMutation({
  args: {
...
export const completeTask = businessMutation({
  args: {
    taskId: v.id("scheduledTasks"),
...
export const listCrons = businessQuery({
  args: {},
  handler: async (ctx) => {
...
export const toggleCron = businessMutation({
  args: {
    name: v.string(),
    enabled: v.boolean(),
  },
...
export const registerCronFailure = businessMutation({
  args: {
    name: v.string(),
    error: v.string(),
  },
...
export const registerCronSuccess = businessMutation({
  args: {
    name: v.string(),
  },
...
export const seedCronConfigs = businessMutation({
  args: {},
  handler: async (ctx) => {
    const defaults = [
